      ...
      <Navbar className="test" collapseOnSelect>
        ...
        <Navbar.Collapse>
          ...
          <Nav pullRight>
            ...
            <NavItem eventKey={2} href="#" onClick={ () => window.scrollTo(0,document.body.scrollHeight/3)}>
              About
            </NavItem>
            <NavItem eventKey={3} href="https://github.com/rainmire/TourGuide" target="_blank">
              Github
            </NavItem>
